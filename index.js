let boxElemsBt = document.getElementsByClassName("asced-list__transparency-button")
for (let index = 0; index < boxElemsBt.length; index++) {
...
let boxElems = document.getElementsByClassName("box-question")
// for (let index = 0; index < boxElems.length; index++) {
...
for (let index = 0; index < boxElems.length; index++) {
  boxElems[index].onclick = function (event) {
    ...
    if (event.currentTarget.classList.contains("box-question--active")) {
      ...
      let openElem = event.currentTarget.parentElement.getElementsByClassName("box-question--active")[0]
